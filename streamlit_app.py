        ...
        with st.form("edit_patient_form"):
            ...
            if update_button:
                ...
                if not existing_data[existing_data["ID"] == selected_id].empty:
                    ...
                    existing_data.at[existing_data[existing_data["ID"] == selected_id].index[0], "Describe Appointment Type If Applicable"] = appointment_type_other if appointment_type_other else None
